...
// recursive function which will allow the user to create 2 starting players and
...
var createPlayer = function () {
  ...
  if (starters.length + subs.length < 3) {
    ...
    inquirer.prompt([{
      ...
      var player = new Player(answers.name, answers.position, parseInt(answers.offense),
